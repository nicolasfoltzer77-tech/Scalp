...
class CcxtBitgetAdapter:
    """
    Adapter CCXT pour Bitget (REST). Simple, robuste, idempotence via clientOid.
    """
    def __init__(
        self,
        ...
        *,
        ...
        default_type: str = "swap",           # "swap" (perp USDT) ou "spot"
        ...
        sandbox = sandbox if sandbox is not None else _env("BITGET_SANDBOX", "1") == "1"
        try:
    ...
    # préparation dérivés (best effort)
    ...
    # ORDRES
    def create_order(
        self, symbol: str, side: str, type_: str, amount: float, price: Optional[float] = None,
