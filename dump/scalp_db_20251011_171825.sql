 ...
 * Exported: 2025-10-11 15:18:28 UTC
 ***************************************************************************/
...
CREATE TABLE ohlcv_3m(symbol TEXT, ts INTEGER, o REAL,h REAL,l REAL,c REAL,v REAL, PRIMARY KEY(symbol,ts));
 ...
 * Exported: 2025-10-11 15:18:29 UTC
 ***************************************************************************/
...
, tp REAL, margin REAL, created_ts INTEGER);
...
/* v_signals_open(id,symbol,side,ctx,score,ts,entry,lev,qty,notional,sl,tp1,tp2,tp3,tp,margin,created_ts) */;
...
CREATE TABLE b_state(
  symbol TEXT PRIMARY KEY, last_side TEXT, consec INTEGER, last_ts INTEGER
);
CREATE TABLE v_contexts_A_latest(
  symbol TEXT PRIMARY KEY, ctx TEXT, pb REAL, ph REAL, ps REAL, ts INTEGER
);
CREATE INDEX idx_sigB_sym_ts ON signals_B(symbol, created_ts);
CREATE TABLE v_indic_1m_new_1301589(
  symbol TEXT, ts INTEGER,
  open REAL, high REAL, low REAL, close REAL, volume REAL,
  spread_frac REAL, vol_sma20 REAL,
  sma9 REAL, sma21 REAL, sma50 REAL,
  atr14 REAL, atr_pct REAL,
  hh_20_excl REAL, ll_20_excl REAL
);
CREATE TABLE v_indic_1m_new_1760101190_1306321(
  symbol TEXT, ts INTEGER,
  open REAL, high REAL, low REAL, close REAL, volume REAL,
  spread_frac REAL, vol_sma20 REAL,
  sma9 REAL, sma21 REAL, sma50 REAL,
...
CREATE TABLE v_indic_1m_new_1760102657_1313694(
  symbol TEXT, ts INTEGER,
  open REAL, high REAL, low REAL, close REAL, volume REAL,
  spread_frac REAL, vol_sma20 REAL,
  sma9 REAL, sma21 REAL, sma50 REAL,
...
CREATE TABLE v_indic_1m_new_1760102718_1314030(
  symbol TEXT, ts INTEGER,
  open REAL, high REAL, low REAL, close REAL, volume REAL,
  spread_frac REAL, vol_sma20 REAL,
  sma9 REAL, sma21 REAL, sma50 REAL,
...
CREATE TABLE v_indic_1m_new_1760104057_1320449(
  symbol TEXT, ts INTEGER,
  open REAL, high REAL, low REAL, close REAL, volume REAL,
  spread_frac REAL, vol_sma20 REAL,
  sma9 REAL, sma21 REAL, sma50 REAL,
...
CREATE TABLE v_indic_1m_new_1760105703_1327908(
  symbol TEXT, ts INTEGER,
  open REAL, high REAL, low REAL, close REAL, volume REAL,
  spread_frac REAL, vol_sma20 REAL,
  sma9 REAL, sma21 REAL, sma50 REAL,
...
CREATE TABLE v_indic_1m_new_1760106622_1334901(
  symbol TEXT, ts INTEGER,
  open REAL, high REAL, low REAL, close REAL, volume REAL,
  spread_frac REAL, vol_sma20 REAL,
  sma9 REAL, sma21 REAL, sma50 REAL,
...
CREATE TABLE v_indic_1m_new_1760106929_1336300(
  symbol TEXT, ts INTEGER,
  open REAL, high REAL, low REAL, close REAL, volume REAL,
  spread_frac REAL, vol_sma20 REAL,
  sma9 REAL, sma21 REAL, sma50 REAL,
...
CREATE TABLE v_indic_1m_new_1760107721_1340062(
  symbol TEXT, ts INTEGER,
  open REAL, high REAL, low REAL, close REAL, volume REAL,
  spread_frac REAL, vol_sma20 REAL,
  sma9 REAL, sma21 REAL, sma50 REAL,
...
CREATE TABLE v_indic_1m_new_1760107968_1341319(
  symbol TEXT, ts INTEGER,
  open REAL, high REAL, low REAL, close REAL, volume REAL,
  spread_frac REAL, vol_sma20 REAL,
  sma9 REAL, sma21 REAL, sma50 REAL,
...
CREATE TABLE v_indic_1m_new_1760109068_1347024(
  symbol TEXT, ts INTEGER,
  open REAL, high REAL, low REAL, close REAL, volume REAL,
  spread_frac REAL, vol_sma20 REAL,
  sma9 REAL, sma21 REAL, sma50 REAL,
...
CREATE TABLE v_indic_1m_new_1760109432_1348903(
  symbol TEXT, ts INTEGER,
  open REAL, high REAL, low REAL, close REAL, volume REAL,
  spread_frac REAL, vol_sma20 REAL,
  sma9 REAL, sma21 REAL, sma50 REAL,
...
CREATE TABLE v_indic_1m_new_1760110719_1354587(
  symbol TEXT, ts INTEGER,
  open REAL, high REAL, low REAL, close REAL, volume REAL,
  spread_frac REAL, vol_sma20 REAL,
  sma9 REAL, sma21 REAL, sma50 REAL,
...
CREATE TABLE v_indic_1m_new_1760111271_1362430(
  symbol TEXT, ts INTEGER,
  open REAL, high REAL, low REAL, close REAL, volume REAL,
  spread_frac REAL, vol_sma20 REAL,
  sma9 REAL, sma21 REAL, sma50 REAL,
...
CREATE TABLE v_indic_1m_new_1760112493_1368755(
  symbol TEXT, ts INTEGER,
  open REAL, high REAL, low REAL, close REAL, volume REAL,
  spread_frac REAL, vol_sma20 REAL,
  sma9 REAL, sma21 REAL, sma50 REAL,
...
CREATE TABLE v_indic_1m_new_1760113288_1372782(
  symbol TEXT, ts INTEGER,
  open REAL, high REAL, low REAL, close REAL, volume REAL,
  spread_frac REAL, vol_sma20 REAL,
  sma9 REAL, sma21 REAL, sma50 REAL,
...
CREATE TABLE v_indic_1m_new_1760113716_1374678(
  symbol TEXT, ts INTEGER,
  open REAL, high REAL, low REAL, close REAL, volume REAL,
  spread_frac REAL, vol_sma20 REAL,
  sma9 REAL, sma21 REAL, sma50 REAL,
...
CREATE TABLE v_indic_1m_new_1760113839_1375276(
  symbol TEXT, ts INTEGER,
  open REAL, high REAL, low REAL, close REAL, volume REAL,
  spread_frac REAL, vol_sma20 REAL,
  sma9 REAL, sma21 REAL, sma50 REAL,
...
CREATE TABLE v_indic_1m_new_1760115062_1381314(
  symbol TEXT, ts INTEGER,
  open REAL, high REAL, low REAL, close REAL, volume REAL,
  spread_frac REAL, vol_sma20 REAL,
  sma9 REAL, sma21 REAL, sma50 REAL,
...
CREATE TABLE v_indic_1m_new_1760115494_1383202(
  symbol TEXT, ts INTEGER,
  open REAL, high REAL, low REAL, close REAL, volume REAL,
  spread_frac REAL, vol_sma20 REAL,
  sma9 REAL, sma21 REAL, sma50 REAL,
...
CREATE TABLE v_indic_1m_new_1760116716_1388652(
  symbol TEXT, ts INTEGER,
  open REAL, high REAL, low REAL, close REAL, volume REAL,
  spread_frac REAL, vol_sma20 REAL,
  sma9 REAL, sma21 REAL, sma50 REAL,
...
CREATE TABLE v_indic_1m_new_1760116839_1389219(
  symbol TEXT, ts INTEGER,
  open REAL, high REAL, low REAL, close REAL, volume REAL,
  spread_frac REAL, vol_sma20 REAL,
  sma9 REAL, sma21 REAL, sma50 REAL,
...
CREATE TABLE v_indic_1m_new_1760116960_1389723(
  symbol TEXT, ts INTEGER,
  open REAL, high REAL, low REAL, close REAL, volume REAL,
  spread_frac REAL, vol_sma20 REAL,
  sma9 REAL, sma21 REAL, sma50 REAL,
...
CREATE TABLE v_indic_1m_new_1760117944_1394106(
  symbol TEXT, ts INTEGER,
  open REAL, high REAL, low REAL, close REAL, volume REAL,
  spread_frac REAL, vol_sma20 REAL,
  sma9 REAL, sma21 REAL, sma50 REAL,
...
CREATE TABLE v_indic_1m_new_1760118191_1395231(
  symbol TEXT, ts INTEGER,
  open REAL, high REAL, low REAL, close REAL, volume REAL,
  spread_frac REAL, vol_sma20 REAL,
  sma9 REAL, sma21 REAL, sma50 REAL,
...
CREATE TABLE v_indic_1m_new_1760118252_1395501(
  symbol TEXT, ts INTEGER,
  open REAL, high REAL, low REAL, close REAL, volume REAL,
  spread_frac REAL, vol_sma20 REAL,
  sma9 REAL, sma21 REAL, sma50 REAL,
...
CREATE TABLE v_indic_1m_new_1760119294_1400181(
  symbol TEXT, ts INTEGER,
  open REAL, high REAL, low REAL, close REAL, volume REAL,
  spread_frac REAL, vol_sma20 REAL,
  sma9 REAL, sma21 REAL, sma50 REAL,
...
CREATE TABLE v_indic_1m_new_1760119416_1400710(
  symbol TEXT, ts INTEGER,
  open REAL, high REAL, low REAL, close REAL, volume REAL,
  spread_frac REAL, vol_sma20 REAL,
  sma9 REAL, sma21 REAL, sma50 REAL,
...
CREATE TABLE v_indic_1m_new_1760121501_1410179(
  symbol TEXT, ts INTEGER,
  open REAL, high REAL, low REAL, close REAL, volume REAL,
  spread_frac REAL, vol_sma20 REAL,
  sma9 REAL, sma21 REAL, sma50 REAL,
...
CREATE TABLE v_indic5m_fast_new_1760121501_1410179(symbol TEXT PRIMARY KEY, ts INTEGER, sma9 REAL, sma21 REAL);
CREATE TABLE v_indic_1m_new_1760123101_1417985(
  symbol TEXT, ts INTEGER,
  open REAL, high REAL, low REAL, close REAL, volume REAL,
  spread_frac REAL, vol_sma20 REAL,
  sma9 REAL, sma21 REAL, sma50 REAL,
...
CREATE TABLE v_indic5m_fast_new_1760123101_1417985(symbol TEXT PRIMARY KEY, ts INTEGER, sma9 REAL, sma21 REAL);
CREATE TABLE v_indic_1m_new_1760147843_1538224(
  symbol TEXT, ts INTEGER,
  open REAL, high REAL, low REAL, close REAL, volume REAL,
  spread_frac REAL, vol_sma20 REAL,
  sma9 REAL, sma21 REAL, sma50 REAL,
...
CREATE TABLE v_indic5m_fast_new_1760147843_1538224(symbol TEXT PRIMARY KEY, ts INTEGER, sma9 REAL, sma21 REAL);
CREATE TABLE v_indic_1m_new_1760159172_1593719(
  symbol TEXT, ts INTEGER,
  open REAL, high REAL, low REAL, close REAL, volume REAL,
  spread_frac REAL, vol_sma20 REAL,
  sma9 REAL, sma21 REAL, sma50 REAL,
...
CREATE TABLE v_indic5m_fast_new_1760159172_1593719(symbol TEXT PRIMARY KEY, ts INTEGER, sma9 REAL, sma21 REAL);
CREATE TABLE v_feat_1m(
  symbol TEXT, ts INTEGER,
  open REAL, high REAL, low REAL, close REAL, volume REAL,
  tp REAL, vwap20 REAL,
  bb_mid20 REAL, bb_up20 REAL, bb_dn20 REAL,
  macd REAL, macd_signal9 REAL, macd_hist REAL,
  obv REAL
);
CREATE TABLE v_indic_1m_new_1760184591_1720835(
  symbol TEXT, ts INTEGER,
  open REAL, high REAL, low REAL, close REAL, volume REAL,
  spread_frac REAL, vol_sma20 REAL,
  sma9 REAL, sma21 REAL, sma50 REAL,
...
CREATE TABLE v_indic5m_fast_new_1760184591_1720835(symbol TEXT PRIMARY KEY, ts INTEGER, sma9 REAL, sma21 REAL);
CREATE TABLE v_indic_1m_new_1760185809_1727019(
  symbol TEXT, ts INTEGER,
  open REAL, high REAL, low REAL, close REAL, volume REAL,
  spread_frac REAL, vol_sma20 REAL,
  sma9 REAL, sma21 REAL, sma50 REAL,
...
CREATE TABLE v_indic5m_fast_new_1760185809_1727019(symbol TEXT PRIMARY KEY, ts INTEGER, sma9 REAL, sma21 REAL);
CREATE TABLE v_indic_1m_new_1760194095_1770377(
  symbol TEXT, ts INTEGER,
  open REAL, high REAL, low REAL, close REAL, volume REAL,
  spread_frac REAL, vol_sma20 REAL,
  sma9 REAL, sma21 REAL, sma50 REAL,
...
CREATE TABLE IF NOT EXISTS "v_indic_1m"(
  symbol TEXT, ts INTEGER,
  open REAL, high REAL, low REAL, close REAL, volume REAL,
  spread_frac REAL, vol_sma20 REAL,
  sma9 REAL, sma21 REAL, sma50 REAL,
...
CREATE TABLE IF NOT EXISTS "v_indic5m_fast"(symbol TEXT PRIMARY KEY, ts INTEGER, sma9 REAL, sma21 REAL);
...
CREATE TABLE sym_map(raw TEXT PRIMARY KEY, instId TEXT);
CREATE TABLE ticks (instId TEXT NOT NULL, lastPr REAL, bidPr REAL, askPr REAL, bidSz REAL, askSz REAL, ts_ms INTEGER NOT NULL, PRIMARY KEY(instId, ts_ms));
...
WITH last AS (
  SELECT run_id FROM universe_runs
  WHERE status='published'
  ORDER BY finished_at DESC LIMIT 1
)
SELECT s.symbol
FROM universe_snapshots s, last
WHERE s.run_id = last.run_id
...
CREATE TABLE x_params(
  id INTEGER PRIMARY KEY CHECK(id=1),
  risk_usd REAL,        -- budget par trade en USD
  max_pos_per_symbol INTEGER,
  leverage REAL,
  slippage_bps REAL     -- exécution paper: bps ajoutés
, tp_mult REAL, sl_mult REAL, score_boost REAL, risk_pct REAL, base_ccy TEXT);
...
CREATE TABLE x_orders(
  ...
  sl REAL, tp REAL, reason TEXT,
  status TEXT,    -- NEW|FILLED|CLOSED|CANCELLED
  signal_id INTEGER,
  created_ts INTEGER, updated_ts INTEGER
, score REAL, leverage REAL, margin REAL, notional REAL);
CREATE INDEX idx_xo_sym_status ON x_orders(symbol,status);
CREATE TABLE x_positions(
  symbol TEXT PRIMARY KEY,
  side TEXT, qty REAL, entry REAL,
  sl REAL, tp REAL,
  open_ts INTEGER
);
CREATE TABLE x_fills(
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  order_id INTEGER, symbol TEXT,
  side TEXT, price REAL, qty REAL,
  fill_ts INTEGER, kind TEXT       -- OPEN|CLOSE|PART
);
CREATE TABLE x_ledger(
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  symbol TEXT, event TEXT, detail TEXT,
  pnl REAL, ts INTEGER
);
CREATE TABLE x_wallet(
 id INTEGER PRIMARY KEY CHECK(id=1),
 start_balance REAL, balance REAL, equity REAL, updated_ts INTEGER
);
CREATE UNIQUE INDEX ux_x_orders_sym_side_ts
ON x_orders(symbol, side, created_ts);
CREATE TABLE x_trades(
  order_id INTEGER PRIMARY KEY,
  symbol TEXT, side TEXT, reason TEXT, score REAL,
  qty REAL,
  entry_px REAL, exit_px REAL,
  entry_ts INTEGER, exit_ts INTEGER,
  sl REAL, tp REAL,
  pnl REAL, ret_pct REAL, hold_secs INTEGER
);
CREATE TABLE x_stats_symbol(
  symbol TEXT PRIMARY KEY,
  n INTEGER, wins INTEGER, win_rate REAL,
  pf REAL, exp_pnl REAL, avg_ret REAL, med_ret REAL,
  n30 INTEGER, win_rate30 REAL, pf30 REAL, exp30 REAL
);
CREATE TABLE x_stats_reason(
  reason TEXT PRIMARY KEY,
  n INTEGER, wins INTEGER, win_rate REAL,
  pf REAL, exp_pnl REAL, avg_ret REAL, med_ret REAL
);
CREATE TABLE x_overrides(
  symbol TEXT, reason TEXT,
  risk_pct REAL, leverage REAL,
  updated_ts INTEGER,
  PRIMARY KEY(symbol,reason)
);
CREATE TABLE x_stats_symbol_reason(
  symbol TEXT, reason TEXT,
  n INTEGER, wins INTEGER, win_rate REAL, pf REAL, exp_pnl REAL,
  PRIMARY KEY(symbol,reason)
);
