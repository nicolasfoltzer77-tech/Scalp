...
FROM ctx_a_latest
/* v_ctx_latest(instId,ts,score_U,score_A,p_buy,p_sell,ctx) */;
...
CREATE TABLE positions_closed(
        ...
        , qty REAL DEFAULT 0, reason_entry TEXT, reason_exit TEXT);
...
CREATE TABLE positions_open (
    ...
    reason       TEXT,
    ts_open      INTEGER
, usd_size REAL, break_even_set INTEGER DEFAULT 0, pyramided INTEGER DEFAULT 0, BE INTEGER DEFAULT 0, PYR INTEGER DEFAULT 0, reason_entry TEXT);
