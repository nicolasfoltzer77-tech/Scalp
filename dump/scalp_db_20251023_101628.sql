 ...
 * Exported: 2025-10-23 08:16:30 UTC
 ***************************************************************************/
...
CREATE TABLE positions_open (
  ...
  reason      TEXT
, tf_agree INTEGER DEFAULT 0, ctx TEXT DEFAULT '', failsafe INTEGER DEFAULT 0);
...
/* v_x_pnl(id,instId,side,entry,exit,qty,leverage,ts_open,ts_close,pnl_usdt,pnl_pct,reason_exit,score_H,score_U,score_A,score_B,tf_agree,ctx,reason) */;
CREATE TABLE positions_closed (
  ...
  pnl_pct REAL,
  reason_exit TEXT
, score_H REAL DEFAULT 0.0, score_U REAL DEFAULT 0.0, score_A REAL DEFAULT 0.0, score_B REAL DEFAULT 0.0, tf_agree INTEGER DEFAULT 0, ctx TEXT DEFAULT '', reason TEXT DEFAULT '');
